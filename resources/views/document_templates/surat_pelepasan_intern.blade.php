    ...
    <div>
        ...
        <div>
            ...
            <br><span style="display: inline-block;min-width: 4rem">Hal</span><span style="display: inline-block">:
                Penyerahan Peserta Praktik Kerja Lapangan (PKL)</span>
        ...
        <div>
            <p>Dengan hormat,</p>
            <p>Menindaklanjuti surat permohonan kami tentang pelaksanaan Praktik Kerja Lapangan (PKL)
                yang telah kami sampaikan kepada Bapak/Ibu, maka dengan ini kami serahkan peserta didik kami untuk dapat
                melaksanakan kegiatan Praktik Kerja Lapangan (PKL) tahun pelajaran
                {{ $academic_year ?? '###' }} di perusahaan
                atau instansi yang Bapak/Ibu pimpin.</p>
            <p>Adapun waktu pelaksanaan kegiatan Praktik Kerja Lapangan (PKL) mengacu pada
                Kalender Pendidikan yakni tanggal {{ $internship_start_date ?? '#####' }} sampai dengan
                {{ $internship_end_date ?? '#####' }}.</p>
        </div>
        ...
        <div>
            <span style="display: inline-block;min-width: 4rem">Guru Pembimbing yang ditugaskan</span><span
                style="display: inline-block">: {{ $advisor_name ?? '' }}</span>
            <br><span style="display: inline-block;min-width: 4rem">No. HP</span><span style="display: inline-block">:
                {{ $advisor_phone_num ?? '' }}</span>
            ...
            <p>Demikian surat penyerahan peserta Praktik Kerja Lapangan (PKL) ini kami sampaikan. Atas kerja sama

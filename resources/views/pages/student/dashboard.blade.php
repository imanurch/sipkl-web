    ...
    <div class="w-full">
        <div class="grid md:grid-cols-2 gap-y-2 gap-x-5">
            ...
            <div class="flex space-x-3 place-items-center">
                ...
                <span>:</span>                
                <input class="input w-full" type="text" value="{{ $studentData->gender }}" disabled>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="w-full">
        <div class="grid md:grid-cols-2 gap-y-2 gap-x-5">
            <div class="flex space-x-3 place-items-center">
                ...
                <span>:</span>                
                <input class="input w-full" type="text" value="{{ $internshipData->industry->name }}" disabled>
            </div>
            <div class="flex space-x-3 place-items-center">
                <h6 class="text-xs-reguler w-32" for="">Guru Pembimbing</h6>
                <span>:</span>                
                <input class="input w-full" type="text" value="{{ $internshipData->advisor->name }} ({{ $internshipData->advisor->phone_num }})" disabled>
            </div>  
            <div class="flex space-x-3 place-items-center">
                <h6 class="text-xs-reguler w-32" for="">Alamat</h6>
                <span>:</span>                
                <input class="input w-full" type="text" value="{{ $internshipData->industry->address }}" disabled>
            </div>   
            <div class="flex space-x-3 place-items-center">
            ...
            <div class="flex space-x-3 place-items-center">
                ...
                <span>:</span>                
                <input class="input w-full" type="text" value="{{ $internshipData->start_date }} s/d {{ $internshipData->end_date }}" disabled>
            </div>
        </div>
    </div>
</div>

        ...
        <div class="w-full">
            <div class="grid md:grid-cols-2 gap-y-2 gap-x-5">
                ...
                <div class="flex space-x-3 place-items-center">
                    ...
                    <span>:</span>
                    <input class="input w-full" type="text" value="{{ auth()->user()->email }}" disabled>
                </div>
                <div class="flex space-x-3 place-items-center">
                    <h6 class="text-xs-reguler w-32" for="">NIP</h6>
                    <span>:</span>
                    <input class="input w-full" type="text" value="{{ session('user_bio')->nip }}" disabled>
                </div>
                <div class="flex space-x-3 place-items-center">
                ...
                <div class="flex space-x-3 place-items-center">
                    ...
                    <span>:</span>
                    <input class="input w-full" type="text" value="{{ session('user_bio')->department->name }}" disabled>
                </div>
                <div class="flex space-x-3 place-items-center">
                    <h6 class="text-xs-reguler w-32" for="">Surat Tugas</h6>
                    <span>:</span>
                    cek lagi kode ini
                    @if (session('user_bio')->advisor_document)
                        @foreach (session('user_bio')->advisor_document as $dt)
                            @if ($dt->type == 'surat_tugas')

...
@section('content')
    ...
    {{-- <div class="space-y-2">
        <div class="flex justify-between place-items-center">
            <h3 class="text-sm-semibold">Data Peserta Didik</h3>
            <div>
        ...
        <div class="w-full flex place-items-end space-x-3 px-4 py-3 border border-neutral-100 rounded">
            <div class="flex w-full space-x-2">
                ...
                <div class="space-y-1 w-full">
                    ...
                    <x-table.select_option_filter optionName="status"
                        ...
                        <x-slot name="option">
                            <li class="option-filter-toolbar-table"
                                @click="option=false;selected='Teregistrasi';valueSelected='registered'">Teregistrasi</li>
                            <li class="option-filter-toolbar-table"
            ...
            <div class="flex space-x-2">
                <button type="submit" class="btn btn-success-fill btn-sm h-fit">
                    <span>Terapkan</span>
                </button>
                <a href="{{ $actionForm ?? '' }}" class="btn btn-error-fill btn-sm h-fit">
                    <span>Hapus</span>
                </a>
            </div>
        </div>
    ...
    {{-- <div x-data="{ modal:false, importModal:false, isEdit:false, isDelete:false, isImport:false, option: false, selected:'Pilih Opsi'}" >
    <x-table>
        <x-slot name="tableTitle">Data Peserta Didik</x-slot>
        <x-slot name="filter">
        ...
        <x-slot name="tBody">
            @foreach ($data as $dt)
                <tr>
                    ...
                    <td>{{ $dt->department->name }}</td>        
                    <td>{{ $dt->phone_num }}</td>        
                    <x-status_table status="0" :statusName="$statusName"></x-status_table>       
    ...
    <div x-show="modal" class="w-full" x-data="dataId:{}">
        <x-form>
            ...
            <x-slot name="formBody" >
                <div class="input-group">
                    <label class="input-label" for="">Nama</label>
                    <input name="name" class="input" type="text" placeholder="Masukkan Nama" :disabled="isDelete" :value="isEdit || isDelete ? dataId.name : ''" required>    
                </div>
                <div class="input-group">
                    <label class="input-label" for="">NISN</label>
                    <input name="nisn" class="input" type="text" placeholder="Masukkan NISN" :disabled="isDelete" :value="isEdit || isDelete ? dataId.nisn : ''" required>    
                </div>
                <div class="input-group">
                    <label class="input-label" for="">Jenis Kelamin</label>
                    <input name="gender" class="input" type="text" placeholder="Masukkan Jenis Kelamin" :disabled="isDelete" :value="isEdit || isDelete ? dataId.gender : ''" required>    
                </div>
                <div class="input-group">
                    <label class="input-label" for="">Jurusan</label>
                    <div>
                ...
                <div class="input-group">
                    <label class="input-label" for="">Nomor Telepon</label>
                    <input name="phone_num" class="input" type="text" placeholder="Masukkan Nomor Telepon" :disabled="isDelete" :value="isEdit || isDelete ? dataId.phone_num : ''" required>    
                </div>
                <div class="input-group">
                    <label class="input-label" for="" :hidden="isDelete">Kata Sandi</label>
                    <input name="password" class="input" type="text" placeholder="Masukkan Kata Sandi" :hidden="isDelete" required>    
                </div>
                <div class="input-group">
                    <label class="input-label" for="" :hidden="isDelete">Ulangi Kata Sandi</label>
                    <input name="check_password" class="input" type="text" placeholder="Ulangi Kata Sandi" :hidden="isDelete" required>    
                </div>
            </x-slot>
        </x-form>
    </div>

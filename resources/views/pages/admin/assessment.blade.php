...
@section('content')
    ...
    <div x-data="{ modalAction: null, option: false, selected: 'Pilih Opsi' }">
        ...
        {{-- form --}}
        <div x-show="modalAction != null" class="form-modal" x-data="dataId: {}">
            <x-form>
                ...
                <x-slot name="formBody">
                    ...
                    <div class="input-group">
                        ...
                        <input name="advisor_score" class="input" type="text" :disabled="modalAction == 'isView'"
                            :value="modalAction != null ? dataId.advisor_score : ''">
                    </div>
                    <div class="input-group">
                        <label class="input-label" for="">Nilai Industri</label>
                        <input name="industry_score" class="input" type="text" :disabled="modalAction == 'isView'"
                            :value="modalAction != null ? dataId.industry_score : ''">
                    </div>
                    <div class="input-group">
                        <label class="input-label" for="">Nilai Ujian Akhir PKL</label>
                        <input name="final_test_score" class="input" type="text" :disabled="modalAction == 'isView'"
                            :value="modalAction != null ? dataId.final_test_score : ''">
                    </div>
                </x-slot>
            </x-form>
        </div>

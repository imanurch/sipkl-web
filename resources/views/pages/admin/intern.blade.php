        ...
        <x-form>
            ...
            <x-slot name="formBody" >
                ...
                <div class="input-group">
                    ...
                    <input name="time" class="input" type="text" disabled :value=" modalAction!=null ? dataId.start_date + '-' + dataId.end_date : ''">    
                </div>
                <div class="input-group">
                    <label class="input-label" for="">Guru Pembimbing</label>
                    <div>
                        <button @click="option=!option" class="input input-select w-full" :disabled="modalAction=='isView' || modalAction=='isDelete'">
                ...
                <div class="input-group">
                    ...
                    <input name="industry" class="input" type="text"  disabled :value="modalAction!=null ? dataId.industry : ''" required>    
                </div>
            </x-slot>
        </x-form>
    </div>

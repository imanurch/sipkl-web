<div class="flex space-x-3 fixed bottom-4 right-4">
    <a href="" class="flex place-items-center space-x-2 bg-brand-500 shadow-md rounded text-neutral-0 w-fit py-2 px-4">
        ...
        <h6 class="text-xs-medium">Unduh Buku Pedoman PKL</h6>
    </a>
    <a href="" class="flex place-items-center space-x-2 bg-neutral-0 shadow-md rounded w-fit py-2 px-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M12.25 5.25001L12.25 1.75001M12.25 1.75001H8.74999M12.25 1.75001L7 7M5.83333 1.75H4.55C3.56991 1.75 3.07986 1.75 2.70552 1.94074C2.37623 2.10852 2.10852 2.37623 1.94074 2.70552C1.75 3.07986 1.75 3.56991 1.75 4.55V9.45C1.75 10.4301 1.75 10.9201 1.94074 11.2945C2.10852 11.6238 2.37623 11.8915 2.70552 12.0593C3.07986 12.25 3.56991 12.25 4.55 12.25H9.45C10.4301 12.25 10.9201 12.25 11.2945 12.0593C11.6238 11.8915 11.8915 11.6238 12.0593 11.2945C12.25 10.9201 12.25 10.4301 12.25 9.45V8.16667" stroke="black" stroke-width="0.93" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        <h6 class="text-xs-medium">Admin 1 <span>(081325385045)</span></h6>
    </a>
    <a href="" class="flex place-items-center space-x-2 bg-neutral-0 shadow-md rounded w-fit py-2 px-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M12.25 5.25001L12.25 1.75001M12.25 1.75001H8.74999M12.25 1.75001L7 7M5.83333 1.75H4.55C3.56991 1.75 3.07986 1.75 2.70552 1.94074C2.37623 2.10852 2.10852 2.37623 1.94074 2.70552C1.75 3.07986 1.75 3.56991 1.75 4.55V9.45C1.75 10.4301 1.75 10.9201 1.94074 11.2945C2.10852 11.6238 2.37623 11.8915 2.70552 12.0593C3.07986 12.25 3.56991 12.25 4.55 12.25H9.45C10.4301 12.25 10.9201 12.25 11.2945 12.0593C11.6238 11.8915 11.8915 11.6238 12.0593 11.2945C12.25 10.9201 12.25 10.4301 12.25 9.45V8.16667" stroke="black" stroke-width="0.93" stroke-linecap="round" stroke-linejoin="round"/>

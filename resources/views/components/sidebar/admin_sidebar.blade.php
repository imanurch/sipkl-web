            ...
            <div>
                ...
                <a href="{{ route('admin.adminManagement') }}" class="sidebar-menu">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M9 7.5V10.5M5.58534 2.56577C6.55456 1.89377 7.73129 1.5 9 1.5C12.3137 1.5 15 4.18629 15 7.5V8.4275M3.31224 5.58455C3.10975 6.18607 3 6.83022 3 7.5V10.5C3 13.2261 4.81812 15.5276 7.30797 16.2581M14.7441 12.239C14.197 14.0485 12.8183 15.4969 11.0526 16.1397M10.7437 4.60976C10.2348 4.30207 9.63808 4.125 9 4.125C7.13604 4.125 5.625 5.63604 5.625 7.5V9.7125M12.375 8.28V10.5C12.375 12.364 10.864 13.875 9 13.875C8.36351 13.875 7.76818 13.6988 7.2601 13.3925" stroke="#" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p>Admin</p>
                </a>
                <a href="{{ route('admin.studentManagement') }}" class="sidebar-menu">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M16.5 15.75V14.25C16.5 12.8521 15.5439 11.6775 14.25 11.3445M11.625 2.46807C12.7244 2.91311 13.5 3.99098 13.5 5.25C13.5 6.50902 12.7244 7.58689 11.625 8.03193M12.75 15.75C12.75 14.3522 12.75 13.6533 12.5216 13.1019C12.2172 12.3669 11.6331 11.7828 10.8981 11.4784C10.3467 11.25 9.64783 11.25 8.25 11.25H6C4.60218 11.25 3.90326 11.25 3.35195 11.4784C2.61687 11.7828 2.03284 12.3669 1.72836 13.1019C1.5 13.6533 1.5 14.3522 1.5 15.75M10.125 5.25C10.125 6.90685 8.78185 8.25 7.125 8.25C5.46815 8.25 4.125 6.90685 4.125 5.25C4.125 3.59315 5.46815 2.25 7.125 2.25C8.78185 2.25 10.125 3.59315 10.125 5.25Z" stroke="" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p>Peserta Didik</p>
                </a>
                <a href="{{ route('admin.advisorManagement') }}" class="sidebar-menu">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M15 15.75C15 14.7033 15 14.18 14.8708 13.7541C14.58 12.7953 13.8297 12.045 12.8709 11.7542C12.445 11.625 11.9217 11.625 10.875 11.625H7.125C6.07833 11.625 5.55499 11.625 5.12914 11.7542C4.17034 12.045 3.42003 12.7953 3.12918 13.7541C3 14.18 3 14.7033 3 15.75M12.375 5.625C12.375 7.48896 10.864 9 9 9C7.13604 9 5.625 7.48896 5.625 5.625C5.625 3.76104 7.13604 2.25 9 2.25C10.864 2.25 12.375 3.76104 12.375 5.625Z" stroke="#525A6A" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p>Guru Pembimbing</p>
                </a>
                <a href="{{ route('admin.industryManagement') }}" class="sidebar-menu">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M9.75 8.25H13.35C14.1901 8.25 14.6101 8.25 14.931 8.41349C15.2132 8.5573 15.4427 8.78677 15.5865 9.06901C15.75 9.38988 15.75 9.80992 15.75 10.65V15.75M9.75 15.75V4.65C9.75 3.80992 9.75 3.38988 9.58651 3.06901C9.4427 2.78677 9.21323 2.5573 8.93099 2.41349C8.61012 2.25 8.19008 2.25 7.35 2.25H4.65C3.80992 2.25 3.38988 2.25 3.06901 2.41349C2.78677 2.5573 2.5573 2.78677 2.41349 3.06901C2.25 3.38988 2.25 3.80992 2.25 4.65V15.75M16.5 15.75H1.5M4.875 5.25H7.125M4.875 8.25H7.125M4.875 11.25H7.125" stroke="#525A6A" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p>Industri</p>
                </a>
            </div>
    ...
    <div class="logout">
        <a href="" class="menu-logout">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M10.5001 4.66667L12.8334 7M12.8334 7L10.5001 9.33333M12.8334 7H5.25008M8.75008 2.45236C8.00648 2.00566 7.14314 1.75 6.2223 1.75C3.4302 1.75 1.16675 4.1005 1.16675 7C1.16675 9.89949 3.4302 12.25 6.2223 12.25C7.14314 12.25 8.00648 11.9943 8.75008 11.5476" stroke="##525A6A" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <p>Keluar Akun</p>
        </a>
    </div>

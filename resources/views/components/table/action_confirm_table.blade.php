<td>
    <div class="flex justify-items-center justify-center space-x-2">
        <button @click="modalConfirm='accept';id='{{ $id }}'" class="bg-icon-success rounded p-2 stroke-neutral-0 w-fit">
        ...
        <button @click="modalConfirm='reject';id='{{ $id }}'" class="bg-icon-error rounded p-2 stroke-neutral-0 w-fit">
            <svg class="size-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                fill="none">
